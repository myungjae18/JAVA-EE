						...
						<div class="checkout_container d-flex flex-xxl-row flex-column align-items-start justify-content-start">
								...
								<div class="checkout_form_container">
									<div class="row">
											<div class="col-lg-6">
												...
												<input type="text" name="sender" id="checkout_name" class="checkout_input" required="required">
											</div>
										</div>
										<div>
											<!-- Country -->
											<label for="checkout_country">은행 선택</label>
										...
										<div>
											...
											<input type="text" name="email" id="checkout_email" class="checkout_input" required="required">
										</div>
								</div>
							</div>
							...
							<div class="cart_total">
								<div class="cart_total_inner checkout_box">
									...
									<div class="checkout_button trans_200"><a href="javascript:pay()">결제 하기</a></div>
								</div>
							</div>
